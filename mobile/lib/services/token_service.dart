...
class TokenService {
  ...
  static const String _keyRobotId = "rafiki_robot_id";
  ...
  static Future<void> saveTokens({
    ...
    if (robotId != null && robotId.isNotEmpty) {
      await prefs.setString(_keyRobotId, robotId);
    }
  }
  ...
  static Future<String> getRobotId() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getString(_keyRobotId) ?? "RAFIKI-ROBOT-001";
  }
  ...
  static Future<void> clearSession() async {
    ...
    await prefs.remove(_keyRobotId);
  }
}
